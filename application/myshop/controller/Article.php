...
class Article extends Controller
{
    ...
    public function index()
    {
        ...
        return $this->fetch('index',['iphone'=>$iphone,'brand'=>$brand,'content' => $content,'bd'=>$brands,'bdd'=>$brandd,'bdp'=>$brandp,'rexo'=>$rexo,'cp'=>$computer,'bdb'=>$brandss,'ips'=>$iphone_s,'bdbd'=>$brandsss,'cps'=>$computer_s,'bd_di'=>$bran]);
    }
